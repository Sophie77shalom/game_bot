...
class Application(tk.Frame):
    def __init__(self, master=None):
        ...
        # Start game
        self.board = Board(rows=4, cols=4, win_threshold=4)
    ...
    def createBoard(self, board):
        ...
        self.button03 = tk.Button(self, height = 4, width = 8, text=' ', font='Times 20 bold', bg='gray', fg='white', command = lambda : self.playMove(0,3))
        ...
        self.button13 = tk.Button(self, height = 4, width = 8, text=' ', font='Times 20 bold', bg='gray', fg='white', command = lambda : self.playMove(1,3))
        ...
        self.button23 = tk.Button(self, height = 4, width = 8, text=' ', font='Times 20 bold', bg='gray', fg='white', command = lambda : self.playMove(2,3))
        
        self.button30 = tk.Button(self, height = 4, width = 8, text=' ', font='Times 20 bold', bg='gray', fg='white', command = lambda : self.playMove(3,0))
        self.button31 = tk.Button(self, height = 4, width = 8, text=' ', font='Times 20 bold', bg='gray', fg='white', command = lambda : self.playMove(3,1))
        self.button32 = tk.Button(self, height = 4, width = 8, text=' ', font='Times 20 bold', bg='gray', fg='white', command = lambda : self.playMove(3,2))
        self.button33 = tk.Button(self, height = 4, width = 8, text=' ', font='Times 20 bold', bg='gray', fg='white', command = lambda : self.playMove(3,3))
        ...
        self.button03.grid(row = 1, column = 3)

        self.button10.grid(row = 2, column = 0)
        self.button11.grid(row = 2, column = 1)
        self.button12.grid(row = 2, column = 2)
        self.button13.grid(row = 2, column = 3)
        
        self.button20.grid(row = 3, column = 0)
        self.button21.grid(row = 3, column = 1)
        self.button22.grid(row = 3, column = 2)
        self.button23.grid(row = 3, column = 3)
        
        self.button30.grid(row = 4, column = 0)
        self.button31.grid(row = 4, column = 1)
        self.button32.grid(row = 4, column = 2)
        self.button33.grid(row = 4, column = 3)

        self.reset_button.grid(row = 5, column = 1)
        self.Q_button.grid(row = 5, column = 2)
    ...
    def updateText(self):
        ...
        self.button03.configure(text=self.getText(0,3), state=tk.ACTIVE)
        ...
        self.button13.configure(text=self.getText(1,3), state=tk.ACTIVE)
        ...
        self.button23.configure(text=self.getText(2,3), state=tk.ACTIVE)
        self.button30.configure(text=self.getText(3,0), state=tk.ACTIVE)
        self.button31.configure(text=self.getText(3,1), state=tk.ACTIVE)
        self.button32.configure(text=self.getText(3,2), state=tk.ACTIVE)
        self.button33.configure(text=self.getText(3,3), state=tk.ACTIVE)
    ...
    def displayQ(self):
        ...
        if self.Q_button.config('relief')[-1] == 'sunken':
            ...
            self.button03.configure(text=self.getQValue(0,3), state=tk.DISABLED)
            ...
            self.button13.configure(text=self.getQValue(1,3), state=tk.DISABLED)
            ...
            self.button23.configure(text=self.getQValue(2,3), state=tk.DISABLED)
            self.button30.configure(text=self.getQValue(3,0), state=tk.DISABLED)
            self.button31.configure(text=self.getQValue(3,1), state=tk.DISABLED)
            self.button32.configure(text=self.getQValue(3,2), state=tk.DISABLED)
            self.button33.configure(text=self.getQValue(3,3), state=tk.DISABLED)
